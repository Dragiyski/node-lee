(function () {
    ...
    function DependencyListener(emitter, event, callback) {
        Listener.call(this, emitter, event, callback);
    }
    ...
    var addEventListener = function (event, listener, dependencies) {
        ...
        if (arguments.length >= 3) {
            ...
            if (!isArrayLike(dependencies)) {
                throw new TypeError("Invalid dependency arguments specified, expected array-like or function.");
            }
            this._events[event].get(listener).mergeDependencies(Array.prototype.slice.call(dependencies, 0), Listener);
        }
        return this;
    };
                ...
                dependencies.forEach(function (dependency) {
                    ...
                    if (!this.emitter._events[this.event].has(dependency)) {
                        this.emitter._events[this.event].set(dependency,
                            new DependencyListener(this.emitter, this.event, dependency));
                    }
